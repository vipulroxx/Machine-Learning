...
print "Maximum stock options:", stock_options_sorted[lenght]
...
try:
    Draw(pred, finance_features, poi, mark_poi=False, name="modifiedclusters.pdf", f1_name=feature_1, f2_name=feature_2, f3_name=feature_3)
except NameError:
